...
public class QuartzFishTickProcedure
{
    ...
    public static void executeProcedure(Map<String, Object> dependencies)
    {
        if (dependencies.get("world") == null)
        {
            if (!dependencies.containsKey("world"))
                OreFishMod.LOGGER.warn("Failed to load dependency world for procedure QuartzFishTick!");
            return;
        }
        if (dependencies.get("entity") == null)
        {
            if (!dependencies.containsKey("entity"))
                OreFishMod.LOGGER.warn("Failed to load dependency entity for procedure QuartzFishTick!");
            return;
        }
...
return false;
    ...
    if (world instanceof World && !world.isRemote()) {
        ItemEntity entityToSpawn = new ItemEntity((World)world, entity.lastTickPosX, entity.lastTickPosY, entity.lastTickPosZ, new ItemStack(QuartzScaleItem.block));
