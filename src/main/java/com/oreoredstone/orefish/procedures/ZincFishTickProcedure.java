...
public class ZincFishTickProcedure
{
    ...
    public static void executeProcedure(Map<String, Object> dependencies)
    {
        if (dependencies.get("world") == null)
        {
            if (!dependencies.containsKey("world"))
                OreFishMod.LOGGER.warn("Failed to load dependency world for procedure ZincFishTick!");
            return;
        }
        if (dependencies.get("entity") == null)
        {
            if (!dependencies.containsKey("entity"))
                OreFishMod.LOGGER.warn("Failed to load dependency entity for procedure ZincFishTick!");
            return;
        }
