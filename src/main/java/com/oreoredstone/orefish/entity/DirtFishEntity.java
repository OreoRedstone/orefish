...
import com.oreoredstone.orefish.procedures.DirtFishTickProcedure;
import com.oreoredstone.orefish.procedures.DirtFishRightClickProcedure;
import com.oreoredstone.orefish.item.DirtScaleItem;
import com.oreoredstone.orefish.entity.renderer.DirtFishRenderer;
import com.oreoredstone.orefish.OreFishModElements;

@OreFishModElements.ModElement.Tag
public class DirtFishEntity extends OreFishModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.WATER_CREATURE)
			...
			.size(0.5f, 0.3f)).build("dirt_fish").setRegistryName("dirt_fish");

	public DirtFishEntity(OreFishModElements instance) {
		super(instance, 15);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DirtFishRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("dirt_fish_spawn_egg"));
	}
	...
	public static class CustomEntity extends AnimalEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(DirtScaleItem.block));
		}
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			DirtFishRightClickProcedure.executeProcedure(
		...
		public void baseTick() {
			...
			DirtFishTickProcedure.executeProcedure(Stream
