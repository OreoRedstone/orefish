...
import com.oreoredstone.orefish.entity.IronFishEntity;
...
public class IronFishRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(IronFishEntity.entity,
					renderManager -> new MobRenderer(renderManager, new CodModel(), 0.5f) {

						@Override
						public ResourceLocation getEntityTexture(Entity entity) {
							return new ResourceLocation("ore_fish:textures/entities/iron_fish.png");
						}
					});
		}
	}
