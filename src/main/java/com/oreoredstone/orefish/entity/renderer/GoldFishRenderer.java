...
import com.oreoredstone.orefish.entity.GoldFishEntity;
...
public class GoldFishRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(GoldFishEntity.entity,
					renderManager -> new MobRenderer(renderManager, new CodModel(), 0.5f) {

						@Override
						public ResourceLocation getEntityTexture(Entity entity) {
							return new ResourceLocation("ore_fish:textures/entities/gold_fish.png");
						}
					});
		}
	}
