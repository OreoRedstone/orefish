...
import com.oreoredstone.orefish.entity.IceFishEntity;
...
public class IceFishRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(IceFishEntity.entity,
					renderManager -> new MobRenderer(renderManager, new CodModel(), 0.5f) {

						@Override
						public ResourceLocation getEntityTexture(Entity entity) {
							return new ResourceLocation("ore_fish:textures/entities/ice_fish.png");
						}
					});
		}
	}
