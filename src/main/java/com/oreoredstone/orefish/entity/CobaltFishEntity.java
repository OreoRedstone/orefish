...
import com.oreoredstone.orefish.procedures.CobaltFishTickProcedure;
import com.oreoredstone.orefish.procedures.CobaltFishRightClickProcedure;
import com.oreoredstone.orefish.item.CobaltScaleItem;
import com.oreoredstone.orefish.entity.renderer.CobaltFishRenderer;
import com.oreoredstone.orefish.OreFishModElements;

@OreFishModElements.ModElement.Tag
public class CobaltFishEntity extends OreFishModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.WATER_CREATURE)
			...
			.size(0.5f, 0.3f)).build("cobalt_fish").setRegistryName("cobalt_fish");

	public CobaltFishEntity(OreFishModElements instance) {
		super(instance, 15);
		FMLJavaModLoadingContext.get().getModEventBus().register(new CobaltFishRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("cobalt_fish_spawn_egg"));
	}
	...
	public static class CustomEntity extends AnimalEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(CobaltScaleItem.block));
		}
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			CobaltFishRightClickProcedure.executeProcedure(
		...
		public void baseTick() {
			...
			CobaltFishTickProcedure.executeProcedure(Stream
