...
import com.oreoredstone.orefish.procedures.DiamondFishTickProcedure;
import com.oreoredstone.orefish.procedures.DiamondFishRightClickProcedure;
import com.oreoredstone.orefish.item.DiamondScaleItem;
import com.oreoredstone.orefish.entity.renderer.DiamondFishRenderer;
import com.oreoredstone.orefish.OreFishModElements;

@OreFishModElements.ModElement.Tag
public class DiamondFishEntity extends OreFishModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.WATER_CREATURE)
			...
			.size(0.5f, 0.3f)).build("diamond_fish").setRegistryName("diamond_fish");

	public DiamondFishEntity(OreFishModElements instance) {
		super(instance, 15);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DiamondFishRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("diamond_fish_spawn_egg"));
	}
	...
	public static class CustomEntity extends AnimalEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(DiamondScaleItem.block));
		}
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			DiamondFishRightClickProcedure.executeProcedure(
		...
		public void baseTick() {
			...
			DiamondFishTickProcedure.executeProcedure(Stream
