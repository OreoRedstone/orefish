...
import com.oreoredstone.orefish.procedures.IceFishTickProcedure;
import com.oreoredstone.orefish.procedures.IceFishRightClickProcedure;
import com.oreoredstone.orefish.item.IceScaleItem;
import com.oreoredstone.orefish.entity.renderer.IceFishRenderer;
import com.oreoredstone.orefish.OreFishModElements;

@OreFishModElements.ModElement.Tag
public class IceFishEntity extends OreFishModElements.ModElement
{
    ...
    public static EntityType entity = (EntityType.Builder.< CustomEntity > create(CustomEntity::new, EntityClassification.WATER_CREATURE)
            ...
            .size(0.5f, 0.3f)).build("ice_fish").setRegistryName("ice_fish");

public IceFishEntity(OreFishModElements instance)
{
    super(instance, 15);
    FMLJavaModLoadingContext.get().getModEventBus().register(new IceFishRenderer.ModelRegisterHandler());
    ...
    public void initElements()
{
    ...
    elements.items.add(()-> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("ice_fish_spawn_egg"));
}
...
protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn)
{
    ...
    this.entityDropItem(new ItemStack(IceScaleItem.block));
}
        ...
        public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand)
{
    ...
    IceFishRightClickProcedure.executeProcedure(
        ...
        public void baseTick()
{
    ...
    IceFishTickProcedure.executeProcedure(Stream
