...
import com.oreoredstone.orefish.procedures.GoldFishTickProcedure;
import com.oreoredstone.orefish.procedures.GoldFishRightClickProcedure;
import com.oreoredstone.orefish.item.GoldScaleItem;
import com.oreoredstone.orefish.entity.renderer.GoldFishRenderer;
import com.oreoredstone.orefish.OreFishModElements;

@OreFishModElements.ModElement.Tag
public class GoldFishEntity extends OreFishModElements.ModElement
{
    ...
    public static EntityType entity = (EntityType.Builder.< CustomEntity > create(CustomEntity::new, EntityClassification.WATER_CREATURE)
            ...
            .size(0.5f, 0.3f)).build("gold_fish").setRegistryName("gold_fish");

public GoldFishEntity(OreFishModElements instance)
{
    super(instance, 15);
    ...
    public void initElements()
{
    ...
    elements.items.add(()-> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("gold_fish_spawn_egg"));
}
...
protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn)
{
    ...
    this.entityDropItem(new ItemStack(GoldScaleItem.block));
}
        ...
        public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand)
{
    ...
    GoldFishRightClickProcedure.executeProcedure(
        ...
        public void baseTick()
{
    ...
    GoldFishTickProcedure.executeProcedure(Stream
