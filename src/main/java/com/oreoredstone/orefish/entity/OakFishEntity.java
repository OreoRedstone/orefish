...
import com.oreoredstone.orefish.procedures.OakFishTickProcedure;
import com.oreoredstone.orefish.procedures.OakFishRightClickProcedure;
import com.oreoredstone.orefish.item.OakScaleItem;
import com.oreoredstone.orefish.entity.renderer.OakFishRenderer;
import com.oreoredstone.orefish.OreFishModElements;

@OreFishModElements.ModElement.Tag
public class OakFishEntity extends OreFishModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.WATER_CREATURE)
			...
			.size(0.5f, 0.3f)).build("oak_fish").setRegistryName("oak_fish");

	public OakFishEntity(OreFishModElements instance) {
		super(instance, 15);
		FMLJavaModLoadingContext.get().getModEventBus().register(new OakFishRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("oak_fish_spawn_egg"));
	}
	...
	public static class CustomEntity extends AnimalEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(OakScaleItem.block));
		}
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			OakFishRightClickProcedure.executeProcedure(
		...
		public void baseTick() {
			...
			OakFishTickProcedure.executeProcedure(Stream
