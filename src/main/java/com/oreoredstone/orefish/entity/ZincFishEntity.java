...
import com.oreoredstone.orefish.procedures.ZincFishTickProcedure;
import com.oreoredstone.orefish.procedures.ZincFishRightClickProcedure;
import com.oreoredstone.orefish.item.ZincScaleItem;
import com.oreoredstone.orefish.entity.renderer.ZincFishRenderer;
import com.oreoredstone.orefish.OreFishModElements;

@OreFishModElements.ModElement.Tag
public class ZincFishEntity extends OreFishModElements.ModElement
{
    ...
    public static EntityType entity = (EntityType.Builder.< CustomEntity > create(CustomEntity::new, EntityClassification.WATER_CREATURE)
            ...
            .size(0.5f, 0.3f)).build("zinc_fish").setRegistryName("zinc_fish");

public ZincFishEntity(OreFishModElements instance)
{
    super(instance, 15);
    FMLJavaModLoadingContext.get().getModEventBus().register(new ZincFishRenderer.ModelRegisterHandler());
    ...
    public void initElements()
{
    ...
    elements.items.add(()-> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("zinc_fish_spawn_egg"));
}
...
protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn)
{
    ...
    this.entityDropItem(new ItemStack(ZincScaleItem.block));
}
        ...
        public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand)
{
    ...
    ZincFishRightClickProcedure.executeProcedure(
        ...
        public void baseTick()
{
    ...
    ZincFishTickProcedure.executeProcedure(Stream
