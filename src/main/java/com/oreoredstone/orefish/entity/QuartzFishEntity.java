...
import com.oreoredstone.orefish.procedures.QuartzFishTickProcedure;
import com.oreoredstone.orefish.procedures.QuartzFishRightClickProcedure;
import com.oreoredstone.orefish.item.QuartzScaleItem;
import com.oreoredstone.orefish.entity.renderer.QuartzFishRenderer;
import com.oreoredstone.orefish.OreFishModElements;

@OreFishModElements.ModElement.Tag
public class QuartzFishEntity extends OreFishModElements.ModElement
{
    ...
    public static EntityType entity = (EntityType.Builder.< CustomEntity > create(CustomEntity::new, EntityClassification.WATER_CREATURE)
            ...
            .size(0.5f, 0.3f)).build("quartz_fish").setRegistryName("quartz_fish");

public QuartzFishEntity(OreFishModElements instance)
{
    super(instance, 15);
    FMLJavaModLoadingContext.get().getModEventBus().register(new QuartzFishRenderer.ModelRegisterHandler());
    ...
    public void initElements()
{
    ...
    elements.items.add(()-> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("quartz_fish_spawn_egg"));
}
...
protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn)
{
    ...
    this.entityDropItem(new ItemStack(QuartzScaleItem.block));
}
        ...
        public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand)
{
    ...
    QuartzFishRightClickProcedure.executeProcedure(
        ...
        public void baseTick()
{
    ...
    QuartzFishTickProcedure.executeProcedure(Stream
