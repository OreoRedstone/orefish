...
import com.oreoredstone.orefish.procedures.IronFishTickProcedure;
...
public class IronFishEntity extends OreFishModElements.ModElement
{
    ...
    public static EntityType entity = (EntityType.Builder.< CustomEntity > create(CustomEntity::new, EntityClassification.WATER_CREATURE)
            ...
            .size(0.5f, 0.3f)).build("iron_fish").setRegistryName("iron_fish");

public IronFishEntity(OreFishModElements instance)
{
    super(instance, 15);
    ...
    public void initElements()
{
    ...
    elements.items.add(()-> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("iron_fish_spawn_egg"));
}
...
protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn)
{
    ...
    this.entityDropItem(new ItemStack(IronScaleItem.block));
}
        ...
        public void baseTick()
{
    ...
    IronFishTickProcedure.executeProcedure(Stream
