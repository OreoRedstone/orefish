...
import com.oreoredstone.orefish.procedures.CopperFishTickProcedure;
import com.oreoredstone.orefish.procedures.CopperFishRightClickProcedure;
import com.oreoredstone.orefish.item.CopperScaleItem;
import com.oreoredstone.orefish.entity.renderer.CopperFishRenderer;
import com.oreoredstone.orefish.OreFishModElements;

@OreFishModElements.ModElement.Tag
public class CopperFishEntity extends OreFishModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.WATER_CREATURE)
			...
			.size(0.5f, 0.3f)).build("copper_fish").setRegistryName("copper_fish");

	public CopperFishEntity(OreFishModElements instance) {
		super(instance, 15);
		FMLJavaModLoadingContext.get().getModEventBus().register(new CopperFishRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("copper_fish_spawn_egg"));
	}
	...
	public static class CustomEntity extends AnimalEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(CopperScaleItem.block));
		}
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			CopperFishRightClickProcedure.executeProcedure(
		...
		public void baseTick() {
			...
			CopperFishTickProcedure.executeProcedure(Stream
