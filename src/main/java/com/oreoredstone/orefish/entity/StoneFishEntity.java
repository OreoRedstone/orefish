...
import com.oreoredstone.orefish.procedures.StoneFishTickProcedure;
import com.oreoredstone.orefish.procedures.StoneFishRightClickProcedure;
import com.oreoredstone.orefish.item.StoneScaleItem;
import com.oreoredstone.orefish.entity.renderer.StoneFishRenderer;
import com.oreoredstone.orefish.OreFishModElements;

@OreFishModElements.ModElement.Tag
public class StoneFishEntity extends OreFishModElements.ModElement
{
    ...
    public static EntityType entity = (EntityType.Builder.< CustomEntity > create(CustomEntity::new, EntityClassification.WATER_CREATURE)
            ...
            .size(0.5f, 0.3f)).build("stone_fish").setRegistryName("stone_fish");

public StoneFishEntity(OreFishModElements instance)
{
    super(instance, 15);
    FMLJavaModLoadingContext.get().getModEventBus().register(new StoneFishRenderer.ModelRegisterHandler());
    ...
    public void initElements()
{
    ...
    elements.items.add(()-> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("stone_fish_spawn_egg"));
}
...
protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn)
{
    ...
    this.entityDropItem(new ItemStack(StoneScaleItem.block));
}
        ...
        public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand)
{
    ...
    StoneFishRightClickProcedure.executeProcedure(
        ...
        public void baseTick()
{
    ...
    StoneFishTickProcedure.executeProcedure(Stream
