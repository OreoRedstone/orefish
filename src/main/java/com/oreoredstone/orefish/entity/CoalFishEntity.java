...
import com.oreoredstone.orefish.procedures.CoalFishTickProcedure;
import com.oreoredstone.orefish.procedures.CoalFishRightClickProcedure;
import com.oreoredstone.orefish.item.CoalScaleItem;
import com.oreoredstone.orefish.entity.renderer.CoalFishRenderer;
import com.oreoredstone.orefish.OreFishModElements;

@OreFishModElements.ModElement.Tag
public class CoalFishEntity extends OreFishModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.WATER_CREATURE)
			...
			.size(0.5f, 0.3f)).build("coal_fish").setRegistryName("coal_fish");

	public CoalFishEntity(OreFishModElements instance) {
		super(instance, 15);
		FMLJavaModLoadingContext.get().getModEventBus().register(new CoalFishRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("coal_fish_spawn_egg"));
	}
	...
	public static class CustomEntity extends AnimalEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(CoalScaleItem.block));
		}
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			CoalFishRightClickProcedure.executeProcedure(
		...
		public void baseTick() {
			...
			CoalFishTickProcedure.executeProcedure(Stream
